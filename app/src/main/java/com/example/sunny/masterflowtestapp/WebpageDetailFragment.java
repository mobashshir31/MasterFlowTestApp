package com.example.sunny.masterflowtestapp;
...
import com.example.sunny.masterflowtestapp.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Show the dummy content as text in a TextView.  IMP
        if (mItem != null) {
            ((WebView) rootView.findViewById(R.id.detail_area)).getSettings().setJavaScriptEnabled(true);
            //((WebView) rootView.findViewById(R.id.detail_area)).setLayerType(rootView.LAYER_TYPE_NONE, null);
